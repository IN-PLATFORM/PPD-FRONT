...
const FeatureResult = styled.div`
  ...
  ${(props) => props.result === "abnormal" && ` background-color: #ffd6e5;`}
`;
...
function Result() {
  ...
  return (
    <>
      <ResultContainer>
        <Link to="/Main">
          <Home src={footprintImg} />
        </Link>
        <ResultTypeContainer>
          당신의 보행 진단 결과는
          <br />
          <ResultType>{record.result === 0 ? "" : "비"}정상</ResultType>
          입니다.
        </ResultTypeContainer>
        <SaveButtonContainer>
          <FiFilePlus
      ...
      <FeatureResultContainer>
        <StyledLink state={{ record: record, idx_: 0 }} to="/ResultDetail">
          <FeatureResult
        ...
        <StyledLink state={{ record: record, idx_: 1 }} to="/ResultDetail">
          <FeatureResult
        ...
        <StyledLink state={{ record: record, idx_: 2 }} to="/ResultDetail">
          <FeatureResult
        ...
        <StyledLink state={{ record: record, idx_: 3 }} to="/ResultDetail">
          <FeatureResult
        ...
        <StyledLink state={{ record: record, idx_: 4 }} to="/ResultDetail">
          <FeatureResult
        ...
        <StyledLink state={{ record: record, idx_: 5 }} to="/ResultDetail">
          <FeatureResult
